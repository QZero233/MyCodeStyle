...
ln -s ~/playground/codex/code_style ~/.claude/skills/我的编码风格

# 3. 为 Codex 创建软链接
ln -s ~/playground/codex/code_style ~/.codex/skills/我的编码风格
```
...
```bash
# Claude Code
git clone git@github.com:QZero233/MyCodeStyle.git ~/.claude/skills/我的编码风格

# Codex
git clone git@github.com:QZero233/MyCodeStyle.git ~/.codex/skills/我的编码风格
```
